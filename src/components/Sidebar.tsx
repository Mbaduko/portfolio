    ...
    <aside className="w-80 bg-gradient-to-b from-background to-background/95 border-r border-secondary-bg/30 p-8 space-y-8 shadow-lg">
      ...
      <div className="space-y-6">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-primary-button/20 rounded-xl flex items-center justify-center">
        ...
        <div className="space-y-4 pl-4">
          {/* Phone */}
          <div className="flex items-center space-x-4 p-3 bg-secondary-bg/30 rounded-xl border border-secondary-bg/20 hover:border-primary-button/30 transition-all duration-300 hover:scale-105">
            ...
            <span className="text-sm font-medium text-foreground">+250 791 130 583</span>
          </div>
          ...
          {/* Email */}
          <div className="flex items-start space-x-4 p-3 bg-secondary-bg/30 rounded-xl border border-secondary-bg/20 hover:border-primary-button/30 transition-all duration-300 hover:scale-105">
            ...
            <span className="text-sm font-medium text-foreground break-all">nsengiyumvaclement247@gmail.com</span>
          </div>
          ...
          <div className="flex items-center space-x-4 p-3 bg-secondary-bg/30 rounded-xl border border-secondary-bg/20 hover:border-primary-button/30 transition-all duration-300 hover:scale-105">
            ...
            <span className="text-sm font-medium text-foreground">github.com/mbaduko</span>
          </div>
          ...
          <div className="flex items-center space-x-4 p-3 bg-secondary-bg/30 rounded-xl border border-secondary-bg/20 hover:border-primary-button/30 transition-all duration-300 hover:scale-105">
            ...
            <span className="text-sm font-medium text-foreground">linkedin.com/in/mbaduko</span>
          </div>
        </div>
      </div>
    </aside>
