        ...
        <div className="lg:col-span-2 bg-gradient-to-br from-secondary-bg/40 to-secondary-bg/20 rounded-3xl p-6 border border-secondary-bg/30 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button 
              ...
              className="bg-secondary-bg/60 border border-primary-button/25 text-foreground px-5 py-2.5 rounded-xl font-semibold hover:bg-primary-button/10 hover:border-primary-button/40 hover:text-primary-button transition-all duration-300 transform hover:scale-105 text-sm cursor-pointer backdrop-blur-sm shadow-md hover:shadow-lg"
            >
              <div className="flex items-center justify-center space-x-2">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
