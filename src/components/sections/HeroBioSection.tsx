  ...
  return (
    <SectionWrapper id="home" padding="md" showBackground>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        {/* Professional Journey - Compact */}
        <div className="lg:col-span-2 bg-gradient-to-br from-secondary-bg/30 to-secondary-bg/10 rounded-2xl p-5 border border-secondary-bg/20">
          <h3 className="text-lg font-bold text-foreground mb-3 flex items-center">
            <svg className="w-5 h-5 mr-2 text-primary-button" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" />
            </svg>
            My Journey
          </h3>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <button 
              ...
              className="bg-primary-button text-white px-4 py-2 rounded-lg font-semibold hover:bg-primary-button/90 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-sm cursor-pointer"
            >
            ...
            <button 
              ...
              className="bg-primary-button/20 border border-primary-button/30 text-primary-button px-4 py-2 rounded-lg font-semibold hover:bg-primary-button/30 hover:border-primary-button/50 transition-all duration-300 transform hover:scale-105 text-sm cursor-pointer"
            >
              <div className="flex items-center justify-center space-x-2">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="grid grid-cols-2 gap-2">
          {expertise.map((item, index) => (
            <div 
              key={index} 
              className="bg-gradient-to-br from-secondary-bg/30 to-secondary-bg/10 rounded-xl p-3 border border-secondary-bg/20 hover:border-primary-button/30 transition-all duration-300 cursor-pointer hover:scale-105 hover:shadow-lg"
              onClick={() => scrollToSection('skills')}
            >
              <div className="flex flex-col items-center text-center space-y-2">
                <div className="bg-primary-button/20 w-8 h-8 rounded-lg flex items-center justify-center">
      ...
      {/* Quick Facts - Compact and Always Visible */}
      <div className="bg-gradient-to-r from-primary-button/10 to-accent-text/10 rounded-2xl p-4 border border-primary-button/20">
        <h3 className="text-base font-bold text-foreground mb-3 text-center">Quick Facts</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div 
            className="text-center cursor-pointer hover:scale-105 transition-all duration-300 p-2 rounded-lg hover:bg-primary-button/10"
          ...
          >
            ...
            <div className="text-lg font-bold text-primary-button mb-1">3+</div>
          ...
          >
            ...
            <div className="text-lg font-bold text-primary-button mb-1">25+</div>
          ...
          >
            ...
            <div className="text-lg font-bold text-primary-button mb-1">15+</div>
          ...
          >
            ...
            <div className="text-lg font-bold text-primary-button mb-1">100%</div>
