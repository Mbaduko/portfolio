...
export const Card = ({ 
  ...
  const variantClasses = {
    default: "bg-secondary-bg/30 border-secondary-bg/30 p-6",
    expertise: "bg-secondary-bg/30 border-secondary-bg/30 hover:border-primary-button/30 p-3 shadow-md",
    stats: "bg-primary-button/15 border-primary-button/30 p-5"
  };
